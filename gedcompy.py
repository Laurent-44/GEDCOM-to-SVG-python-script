...
class Individual(Element):
    ...
    def children_of(self, partner):
        """
        Return list of children of this person with the partner.
        :param partner: ID of the Partner
        :returns: List of Individual's
        """
        child_found = False
        if 'FAMS' in self:
            families = self.get_list('FAMS')
            if partner is None:
                family_id = self.get_by_id(families[0].value)
                if 'CHIL' in family_id:
                    children = [p.as_individual() for p in family_id.get_list('CHIL')]
                    child_found = True
            else :
                for family in families :
                    family_id = self.get_by_id(family.value)
                    parents = [p.as_individual() for p in family_id.partners]
                    if partner in parents and 'CHIL' in family_id:
                        children = [p.as_individual() for p in family_id.get_list('CHIL')]
                        child_found = True
        if child_found:
            return children
    ...
    def marriage_with(self, partner):
        """
        Return marriage of this person with the partner.
        :param partner: ID of the Partner
        :returns: Marriage or None
        """
        ...
        if 'FAMS' in self:
            ...
            if partner is None:
                family_id = self.get_by_id(families[0].value)
                if 'MARR' in family_id:
                    marriage = family_id['MARR']
                    marriage_found = True
            else :
                for family in families :
                    family_id = self.get_by_id(family.value)
    ...
    @property
    def adoption(self):
        """Class representing the adoption of this person."""
        return self['ADOP']

    @property
    def baptism(self):
        """Class representing the baptism of this person."""
        return self['BAPM']

    @property
    def basmitzvah(self):
        """Class representing the Bas Mitzvah of this person."""
        return self['BARM']
    ...
    @property
    def blessing(self):
        """Class representing the blessing of this person."""
        return self['BLESS']

    @property
    def burial(self):
        """Class representing the burial of this person."""
        return self['BURI']

    @property
    def census(self):
        """Class representing a census of this person."""
        return self['CENS']

    @property
    def christening(self):
        """Class representing the christening or baptism of this person."""
        return self['CHR']

    @property
    def CHRA(self):
        """Class representing the adult christening or baptism of this person."""
        return self['CHRA']

    @property
    def conf(self):
        """Class representing the confirmation of this person."""
        return self['CONF']

    @property
    def crem(self):
        """Class representing the cremation of this person."""
        return self['CREM']
    ...
    @property
    def emigration(self):
        """Class representing the emigration of this person."""
        return self['EMIG']

    @property
    def event(self):
        """Class representing the events of this person."""
        return self['EVEN']

    @property
    def first_communion(self):
        """Class representing the first communion of this person."""
        return self['FCOM']

    @property
    def graduation(self):
        """Class representing the graduation of this person."""
        return self['GRAD']

    @property
    def immigration(self):
        """Class representing the immigration of this person."""
        return self['IMMI']

    @property
    def naturalization(self):
        """Class representing the naturalization of this person."""
        return self['NATU']

    @property
    def ordination(self):
        """Class representing the ordination of this person."""
        return self['ORDN']

    @property
    def probation(self):
        """Class representing the probation of this person."""
        return self['PROB']

    @property
    def retirement(self):
        """Class representing the retirement of this person."""
        return self['RETI']

    @property
    def will(self):
        """Class representing the will of this person."""
        return self['WILL']


    @property
    def caste(self):
        """Value representing the caste of this person."""
        if 'CAST' in self :
            return ','.join(i.value for i in self.get_list('CAST'))
        else :
            return ''

    @property
    def description(self):
        """Value representing the physical description of this person."""
        if 'DSCR' in self :
            return ','.join(i.value for i in self.get_list('DSCR'))
        else :
            return ''

    @property
    def education(self):
        """Value representing the education of this person."""
        if 'EDUC' in self :
            return ','.join(i.value for i in self.get_list('EDUC'))
        else :
            return ''

    @property
    def fact(self):
        """Value representing the fact of this person."""
        if 'FACT' in self :
            return ','.join(i.value for i in self.get_list('FACT'))
        else :
            return ''

    @property
    def identification(self):
        """Value representing the identifying number of this person."""
        if 'IDNO' in self :
            return self['IDNO'].value
        else :
            return ''

    @property
    def nationality(self):
        """Value representing the nationality of this person."""
        if 'NATI' in self :
            return ','.join(i.value for i in self.get_list('NATI'))
        else :
            return ''

    @property
    def number_children(self):
        """Value representing the number of children of this person."""
        if 'NCHI' in self :
            return self['NCHI'].value
        else :
            return ''

    @property
    def number_marriages(self):
        """Value representing the number of children of this person."""
        if 'NMR' in self :
            return self['NMR'].value
        else :
            return ''

    @property
    def occu(self):
        """Value representing the occupation of this person."""
        if 'OCCU' in self :
            return ','.join(i.value for i in self.get_list('OCCU'))
        else :
            return ''

    @property
    def properties(self):
        """Value representing the properties of this person."""
        if 'PROP' in self :
            return ','.join(i.value for i in self.get_list('PROP'))
        else :
            return ''

    @property
    def refn(self):
        """Value representing the anehentafel reference of this person."""
        if 'REFN' in self :
            return self['REFN'].value
        else :
            return ''

    @property
    def religion(self):
        """Value representing the religion of this person."""
        if 'RELI' in self :
            return ' '.join(i.value for i in self.get_list('RELI'))
        else :
            return ''

    @property
    def residence(self):
        """Value representing the residence of this person."""
        if 'RESI' in self :
            return ','.join(i.value for i in self.get_list('RESI'))
        else :
            return ''

    @property
    def signature(self):
        """Value representing the signature of this person."""
        if 'SIGN' in self :
            return ','.join(i.value for i in self.get_list('SIGN'))
        else :
            return ''

    @property
    def social_security(self):
        """Value representing the social security number of this person."""
        if 'SSN' in self :
            return self['SSN'].value
        else :
            return ''

    @property
    def title(self):
        """Value the value of the Title (TITL) of this person, or None if no title."""
        try:
            return ','.join(i.value for i in self.get_list('TITL'))
        except:
            return None

    @property
    def photo(self):
        """Value representing the file of the first photo of this person."""
        if 'OBJE' in self :
            if type(self['OBJE']) == list:
                if 'FILE' in self['OBJE'][0] :
                    return self['OBJE'][0]['FILE'].value
            else :
                if'FILE' in self['OBJE'] :
                    return self['OBJE']['FILE'].value
        else :
            return None
...
class Family(Element):
    ...
    def husbands(self):
        """
        Return the :py:class:`Husband`'s for this family.
        :return: list
    ...
    def wives(self):
        """
        Return the :py:class:`Wife`'s for this family.
        :return: list
    ...
    def children(self):
        """
        Return the :py:class:`Children`'s for this family.
        :return: list
        :rtype: list of :py:class:`Children`
        """
        return self.get_list('CHIL')

    @property
    def annulment(self):
        """Class representing the annulment of this family."""
        return self['ANNUL']

    @property
    def census(self):
        """Class representing the census of this family."""
        return self['CENS']

    @property
    def divorce(self):
        """Class representing the divorce of this family."""
        return self['DIV']

    @property
    def divorce_filed(self):
        """Class representing the divorce filed of this family."""
        return self['DIVF']

    @property
    def engagement(self):
        """Class representing the engagement of this family."""
        return self['ENGA']

    @property
    def event(self):
        """Class representing the event of this family."""
        return self['EVEN']

    @property
    def marriage_bann(self):
        """Class representing the marriage bann of this family."""
        return self['MARB']

    @property
    def marriage_contract(self):
        """Class representing the marriage contract of this family."""
        return self['MARC']

    @property
    def marriage_license(self):
        """Class representing the marriage license of this family."""
        return self['MARL']

    @property
    def marriage(self):
        """Class representing the marriage of this family."""
        return self['MARR']

    @property
    def marriage_settlement(self):
        """Class representing the marriage settlement of this family."""
        return self['MARS']
...
class Spouse(Element):
    """Generic base class for HUSB/WIFE/CHIL."""
...
class Event(Element):
    ...
    def source(self):
        """
        Get the source of this event, from the 'SOUR' tagged child element.
        :returns: source value
        :rtype: string
        :raises KeyError: if there is no SOUR sub-element
        """
        if 'SOUR' in self :
          return self['SOUR'].full_text
        else :
          return ''
...
class Adoption(Event):
    """Represents an adoption (ADOP)."""
    pass


@register_tag("ANUL")
class Annulment(Event):
    """Represents an annulment (ADOP)."""
    pass


@register_tag("BAPM")
class Baptism(Event):
    """Represents a baptism (BAPM)."""
    pass


@register_tag("BARM")
class BasMitzvah(Event):
    """Represents a Bas Mitzvah (BARM)."""
    pass
...
class Blessing(Event):
    """Represents a blessing (BLESS)."""
    pass


@register_tag("BURI")
class Burial(Event):
    """Represents a burial (BURI)."""
    pass


@register_tag("CENS")
class Census(Event):
    """Represents a census (CENS)."""
    pass


@register_tag("CHR")
class Christening(Event):
    """Represents a christening or baptism (CHR)."""
    pass


@register_tag("CHRA")
class AdultChristening(Event):
    """Represents an adult christening or baptism (CHRA)."""
    pass


@register_tag("CONF")
class Confirmation(Event):
    """Represents a confirmation (CONF)."""
    pass


@register_tag("CREM")
class Cremation(Event):
    """Represents a cremation (CREM)."""
    pass
...
@register_tag("DIVF")
class DivorceFiled(Event):
    """Represents a divorce filed (DIVF)."""
    pass


@register_tag("EMIG")
class Emigration(Event):
    """Represents an emigration (EMIG)."""
    pass


@register_tag("ENGA")
class Engagement(Event):
    """Represents an engagement (ENGA)."""
    pass
...
@register_tag("FCOM")
class FirstCommunion(Event):
    """Represents a first communion (FCOM)."""
    pass


@register_tag("GRAD")
class Graduation(Event):
    """Represents a graduation (GRAD)."""
    pass


@register_tag("IMMI")
class Immigration(Event):
    """Represents an immigration (IMMI)."""
    pass


@register_tag("MARB")
class MarriageBann(Event):
    """Represents a marriage bann (MARB)."""
    pass


@register_tag("MARC")
class MarriageContract(Event):
    """Represents a marriage contract (MARC)."""
    pass


@register_tag("MARL")
class MarriageLicense(Event):
    """Represents a marriage license (MARL)."""
    pass
...
@register_tag("MARS")
class MarriageSettlement(Event):
    """Represents a marriage settlement (MARL)."""
    pass


@register_tag("NATU")
class Naturalization(Event):
    """Represents a naturalization (NATU)."""
    pass


@register_tag("ORDN")
class Ordination(Event):
    """Represents an ordination (ORD)."""
    pass


@register_tag("PROB")
class Probation(Event):
    """Represents a probation (PROB)."""
    pass


@register_tag("RETI")
class Retirement(Event):
    """Represents a retirment (RETI)."""
    pass


@register_tag("WILL")
class Will(Event):
    """Represents a will (WILL)."""
    pass
...
class Source(Element):
    """Represents a source (SOUR)."""

    @property
    def full_text(self):
        """
        Return the full text of this source.
        Internally, notes are stores across many child nodes, with child
        CONT/CONS child nodes that store the other lines. This method assembles
        these elements into one continuusous string.
        """
